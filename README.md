...
var n1, n2, s,d,m,q;
n1=parseInt(prompt("Enter first number:"));
n * 2 = parseInt(prompt("Enter second number:"));
s =n1+n2
d =n2-n1;
m =n1^ * n2
q = n * 1 / n * 2
...
f=f*i;
 ...
 document.getElementById("disp").innerHTML = "Factorial of 7 - "
+f;
}
</script>
</head>
...
len = str.length;
document.getElementById("disp").innerHTML = "Length of String
-" + len;
}
</script>
</head>
...
document.getElementById("disp").innerHTML = "Difference of
dates in days " + diff;
}
</script>
</head>
